...
import vn.edu.tdmu.lethanhhiep.bcnckh.database.dulieusqllite;
...
//
    ...
    private class sukiencuatoi implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            if (view.equals(btn_qmk)) {
                intent = new Intent(MainActivity.this, Forgot.class);
    ...
    private void dangnhap() {
        try {
            ...
            progressDialog.show();
            String ten = "tomhumchinvn@gmail.com";//edtName.getText().toString();
            String mk = "12345678";//edtmk.getText().toString();
            firebaseAuth = FirebaseAuth.getInstance();
