...
public class Forgot extends AppCompatActivity {
    ...
    private void AddConTrol() {
        ...
        arrayAdapter = new ArrayAdapter<String>(Forgot.this, android.R.layout.simple_spinner_item, ch);
            ...
            firebaseAuth.sendPasswordResetEmail(emaill).addOnCompleteListener(new OnCompleteListener<Void>() {
                ...
                public void onComplete(@NonNull Task<Void> task) {
                    if (task.isSuccessful()) {
                        Toast.makeText(Forgot.this, "Please check your email to update the new password and then update the password in the profile page", Toast.LENGTH_SHORT).show();
                    } else {
                        Toast.makeText(Forgot.this, "Password update failed", Toast.LENGTH_SHORT).show();
                    }
                }
            });
        }
    ...
    private void AskUser() {
        AlertDialog.Builder builder = new AlertDialog.Builder(Forgot.this, R.style.AlertDialogStyle);
